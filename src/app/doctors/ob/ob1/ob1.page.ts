...
@Component({
  selector: 'app-ob1',
  templateUrl: './ob1.page.html',
  styleUrls: ['./ob1.page.scss'],
})
export class Ob1Page implements OnInit {
  profileInfo: any;
  datetime!: Date;
  ...
  ngOnInit() {
    const profileInfo = {
      image:  'assets/ob/o1.jpg',
      description: 'MD, FPOGS, FPSUOG',
      name:  'Dr. Emma Panaligan',
      fee: '₱500',
      location: 'Panaligan OB-Gyne Ultrasound Clinc',
      url: 'ob/o1'
